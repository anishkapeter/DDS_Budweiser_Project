...
ggplot(count_df,aes(x=Category, y=Percent)) +
  ...
  ylim(0,40) +
  theme(plot.background = element_rect("#dbdfdf"),axis.text.x = element_text(color = "#13294b",size = 14),axis.text.y = element_text(color = "#13294b",size = 14), axis.title.x = element_text(color = "#13294b",size = 16), axis.title.y =element_text(color = "#13294b",size = 16), plot.title  = element_text(color = "#13294b",size = 18))
...
The maximum ABV is 0.128 from Colorado and the maximum IBU is in Orgeon with a score of 138. 
...
boxplot(accuracies) # min is ~85 and max ~93, which is really good
accuracies
